...
cvar_t cvar_allow_big_cock = { "mp_allow_big_cock","0", FCVAR_SERVER };
cvar_t cvar_allow_all_weapons = { "mp_allow_all_weapons","0", FCVAR_SERVER };
...
void GameDLLInit( void )
{
	...
	CVAR_REGISTER( &cvar_allow_all_weapons );
	CVAR_REGISTER( &cvar_allow_big_cock );
