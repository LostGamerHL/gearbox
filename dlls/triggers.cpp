...
void CChangeLevel::ChangeLevelNow( CBaseEntity *pActivator )
{
	...
	if( mp_coop_reconnect_hack.value )
		SERVER_COMMAND( UTIL_VarArgs( "wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;wait;changelevel %s %s\n", st_szNextMap, st_szNextSpot ) );
	else
